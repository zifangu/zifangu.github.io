(function($){'use strict';window.onload=function(){if(!window.location.hash){window.location=window.location+'#welcome';window.location.reload();}}
$(window).on('load',function(){$('.preloader').fadeOut(100);});function counter(){var oTop;if($('.count').length!==0){oTop=$('.count').offset().top-window.innerHeight;}
